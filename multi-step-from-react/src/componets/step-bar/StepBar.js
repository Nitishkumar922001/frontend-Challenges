    ...
    return (
        <>
            <div className="step-bar">
                <ul>
                    <li>
                        <button className='step-btn' onClick={()=>props.steps.setStep(1)}>1</button>
                        <div>
                    ...
                    <li>
                        <button className='step-btn' onClick={()=>props.steps.setStep(2)}>2</button>
                        <div>
                    ...
                    <li>
                        <button className='step-btn' onClick={()=>props.steps.setStep(3)}>3</button>
                        <div>
